...
export default function ItemRow({
  ...
  item: Item
  // include locationId so we can filter eligible containers
  ...
  // figure out the item's current location via its current container
  ...
  // only show containers in the same location & not the current container
      ...
      <div className="flex-1 space-y-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="text-white bg-indigo-600 hover:bg-indigo-700 px-2 py-1 rounded text-sm disabled:opacity-50"
          >
            Move
          </button>
        </div>
        ...
        <div className="flex items-center gap-2">
          <h1 className="font-medium">Upload an Image</h1>
